...
@pytest.fixture
def test_lawyer(db_session, test_lawyer_user):
...
@pytest.fixture
def test_service_request(db_session, test_user, test_lawyer):
...
class TestServiceRequestDetailRetrieval:
    ...
    def test_user_can_view_own_request(self, client, test_service_request, user_auth_headers):
    ...
    def test_user_cannot_view_other_user_request(self, client, test_service_request, other_user_auth_headers):
    ...
    def test_lawyer_can_view_assigned_request(self, client, test_service_request, lawyer_auth_headers):
    ...
    def test_admin_can_view_any_request(self, client, test_service_request, admin_auth_headers):
    ...
    def test_get_nonexistent_request_returns_404(self, client, user_auth_headers):
    ...
    def test_unauthenticated_request_returns_401(self, client, test_service_request):
...
class TestServiceRequestStatusUpdate:
    ...
    def test_lawyer_can_accept_request(self, client, test_service_request, lawyer_auth_headers):
    ...
    def test_lawyer_can_reject_request(self, client, test_service_request, lawyer_auth_headers):
    ...
    def test_lawyer_can_complete_request(self, client, db_session, test_service_request, lawyer_auth_headers):
        """Test that lawyer can mark request as completed."""
        # First accept the request
        request = db_session.query(ServiceRequest).filter(ServiceRequest.id == test_service_request.id).first()
    ...
    def test_non_lawyer_cannot_update_request(self, client, test_service_request, user_auth_headers):
    ...
    def test_lawyer_cannot_update_other_lawyer_request(self, client, db_session, test_service_request, test_user):
        ...
        db_session.add(other_lawyer_user)
        db_session.commit()
        db_session.refresh(other_lawyer_user)
    ...
    def test_accepting_request_creates_conversation(self, client, test_service_request, lawyer_auth_headers):
...
class TestServiceRequestDeletion:
    ...
    def test_admin_can_delete_pending_request(self, client, db_session, test_service_request, admin_auth_headers):
    ...
    def test_admin_can_delete_rejected_request(self, client, db_session, test_service_request, admin_auth_headers):
    ...
    def test_admin_cannot_delete_accepted_request(self, client, db_session, test_service_request, admin_auth_headers):
    ...
    def test_non_admin_cannot_delete_request(self, client, test_service_request, user_auth_headers):
    ...
    def test_delete_nonexistent_request_returns_404(self, client, admin_auth_headers):

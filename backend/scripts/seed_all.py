"""
Script to seed the database with all mock data (admin, lawyers, regular users).
Run with: docker-compose exec backend python scripts/seed_all.py
"""
...
def seed_all():
    """Seed database with all mock data."""
    db = SessionLocal()
    ...
    try:
        ...
        lawyers_data = [
            {
                "user": {
                    ...
                    "email": "ls.nguyenvanan@vietjusticia.com",
                    "phone": "0901234567",
            ...
            },
            {
                "user": {
                    ...
                    "email": "ls.tranthibinh@vietjusticia.com",
                    "phone": "0902345678",
            ...
            },
            {
                "user": {
                    ...
                    "email": "ls.leminhcuong@vietjusticia.com",
                    "phone": "0903456789",
                    "hashed_password": hash_password("Lawyer@123"),
                    "is_active": True,
                    "is_verified": True,
            ...
            },
            {
                "user": {
                    ...
                    "email": "ls.phamthidung@vietjusticia.com",
                    "phone": "0904567890",
                    "hashed_password": hash_password("Lawyer@123"),
                    "is_active": True,
                    "is_verified": True,
            ...
            },
            {
                "user": {
                    ...
                    "email": "ls.hoangvanem@vietjusticia.com",
                    "phone": "0905678901",
                    "hashed_password": hash_password("Lawyer@123"),
                    "is_active": True,
                    "is_verified": True,
            ...
            },
            {
                "user": {
                    ...
                    "email": "ls.vuthiphuong@vietjusticia.com",
                    "phone": "0906789012",
                    "hashed_password": hash_password("Lawyer@123"),
                    "is_active": True,
                    "is_verified": True,
        ...
        for data in lawyers_data:
            ...
            if not existing_user:
                ...
                print(f"  • Lawyer already exists: {data['user']['email']}")
        ...
        print("  • ls.nguyenvanan@vietjusticia.com")
        print("  • ls.tranthibinh@vietjusticia.com")
        print("  • ls.leminhcuong@vietjusticia.com")
        print("  • ls.phamthidung@vietjusticia.com")
        print("  • ls.hoangvanem@vietjusticia.com")
        print("  • ls.vuthiphuong@vietjusticia.com")
